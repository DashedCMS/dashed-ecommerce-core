...
class CartController extends Controller
{
    public function cart()
    {
        ...
        if (View::exists(config('dashed-core.site_theme', 'dashed') . '.cart.cart')) {
            ...
            return view(config('dashed-core.site_theme', 'dashed') . '.cart.cart');
        } else {
    ...
    public function checkout()
    {
        ...
        if (View::exists(config('dashed-core.site_theme', 'dashed') . '.checkout.checkout')) {
