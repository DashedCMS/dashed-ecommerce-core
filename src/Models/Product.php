...
//        'childProducts',
    ...
    public function getCrossSellProducts(int $limit = 4, bool $random = true): Collection
    {
        ...
        $products = Product::thisSite()->publicShowable()->whereIn('id', $crossSellProductsIds)->limit($limit);
        if ($random) {
            $products->inRandomOrder();
        }
