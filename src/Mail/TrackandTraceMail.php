...
class TrackandTraceMail extends Mailable
{
    ...
    {
        $view = view()->exists(config('dashed-core.site_theme', 'dashed') . '.emails.track-and-trace') ? config('dashed-core.site_theme', 'dashed') . '.emails.track-and-trace' : 'dashed-ecommerce-core::emails.track-and-trace';
