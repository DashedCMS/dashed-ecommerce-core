...
class OrderConfirmationForFulfillerMail extends Mailable
{
    ...
    {
        $view = view()->exists(config('dashed-core.site_theme', 'dashed') . '.emails.confirm-order-for-fulfiller') ? config('dashed-core.site_theme', 'dashed') . '.emails.confirm-order-for-fulfiller' : 'dashed-ecommerce-core::emails.confirm-order-for-fulfiller';
