...
class OrderCancelledWithCreditMail extends Mailable implements RegistersEmailTemplate
{
    ...
    {
        return 'Order geannuleerd met creditnota (klant)';
    }

    public static function emailTemplateDescription(): ?string
    {
        return 'Verzonden naar de klant bij annulering met creditnota als bijlage.';
    }
    ...
    public static function defaultBlocks(): array
    {
        return [
            ...
            ['type' => 'text', 'data' => ['body' => '<p>Beste :customerFirstName:,</p><p>Je bestelling #:orderId: is geannuleerd. In de bijlage vind je de creditnota.</p>']],
