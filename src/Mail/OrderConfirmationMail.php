...
class OrderConfirmationMail extends Mailable
{
    ...
    {
        $view = view()->exists(config('dashed-core.site_theme', 'dashed') . '.emails.confirm-order') ? config('dashed-core.site_theme', 'dashed') . '.emails.confirm-order' : 'dashed-ecommerce-core::emails.confirm-order';
