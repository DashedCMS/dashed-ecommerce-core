                ...
                Repeater::make('products')
                    ...
                    ->schema([
                        ...
                        Placeholder::make('Afbeelding')
                            ->content(fn (Get $get) => $get('product') ? new HtmlString('<img width="300" src="' . (mediaHelper()->getSingleMedia(Product::find($get('product'))->firstImageUrl, 'medium')->url ?? '') . '">') : 'Kies een product'),
