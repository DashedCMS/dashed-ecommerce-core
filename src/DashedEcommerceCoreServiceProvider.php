...
class DashedEcommerceCoreServiceProvider extends PackageServiceProvider
{
    ...
    public function bootingPackage()
    {
        ...
        cms()
            ...
            ->registerMailable(\Dashed\DashedEcommerceCore\Mail\PaymentReminderMail::class)
            ->registerMailable(\Dashed\DashedEcommerceCore\Mail\OrderModifiedMail::class)
...
MARKDOWN,
    ...
    public function configurePackage(Package $package): void
    {
        ...
        cms()->registerSettingsPage(\Dashed\DashedEcommerceCore\Filament\Pages\Settings\QuoteSettingsPage::class, 'Offertes', 'document-text', 'Nummerformaat, geldigheidsduur, standaardteksten en herinneringen voor offertes');
        ...
        $package
            ...
            ->hasCommands([
                ...
                \Dashed\DashedEcommerceCore\Commands\SendOrderHandledFlowEmails::class,
                PruneCartLogs::class,
                ...
                \Dashed\DashedEcommerceCore\Commands\PrintQueue\BackfillPrintedShippingLabelsCommand::class,
