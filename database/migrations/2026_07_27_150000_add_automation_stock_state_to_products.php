...
return new class () extends Migration {
    /**
     * Marker-kolom voor de dedup/reset-logica van StockRuleScanner
     ...
     * stock-historie bijgehouden), dus Product houdt zelf bij wanneer een
     ...
     *   inclusief bij aanmaak met stock 0 — zie Product::booted()).
