                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('admin-pre-order-confirmation-email-title', 'pre-orders', 'Je hebt een pre-order bestelling ontvangen: #:orderId:!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! nl2br(Translation::get('admin-pre-order-confirmation-email-content', 'pre-orders', 'Je kan deze bestelling in het CMS bekijken', 'textarea'))!!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                href="{{ route('filament.dashed.resources.orders.view', [$order]) }}"
                                                                                ...
                                                                                target="_blank"> {{Translation::get('pre-order-confirmation-email-view-order-button', 'pre-orders', 'Bekijk bestelling')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        @if($order->orderProducts()->where('sku', 'payment_costs')->first() && $order->orderProducts()->where('sku', 'payment_costs')->first()->price > 0.00)
                                                            <tr>
                                                                <td width="75%"
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                                <span
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #999999;">{{Translation::get('order-confirmation-email-order-payment-costs', 'orders', 'Betaalmethode kosten')}} </span>
                                                                </td>
                                                                <td width="25%" align="right"
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                                <span
