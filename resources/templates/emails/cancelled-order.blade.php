                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-cancelled-email-title', 'orders', 'Je bestelling #:orderId: is geannuleerd!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br> {!! Translation::get('order-cancelled-email-greeting', 'orders', 'Hallo :name:,', 'text', [
    'name' => $order->name
]) !!} <br><br>

                                                                    {!! nl2br(Translation::get('order-cancelled-email-content', 'orders', 'Je bestelling is geannuleerd.', 'textarea')) !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 20px; color: #333; padding-left: 10px;">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                            {{$order->parentCreditOrder->paymentMethod}}

                                                            @if($order->parentCreditOrder->paymentMethodInstructions)
                                                                <br><br>
                                                                {{$order->parentCreditOrder->paymentMethodInstructions}}
                                                            @endif
                                                        </div>
                                                    </div>
                                                </td>
