                ...
                @foreach($this->cartItems as $item)
                    <div class="grid grid-cols-12 gap-4 border-b border-primary py-4">
                        ...
                        <div class="col-span-8 lg:col-span-4 flex items-center">
                            <div class="inline-flex items-center h-10 overflow-hidden border border-gray-200">
                                ...
                                <input class="w-16 h-10 text-center text-primary-500 font-bold" type="number" value="{{$item->qty}}"
                                       disabled
                ...
                <div>
                    <form wire:submit.prevent="applyDiscountCode" class="flex justify-between">
                        ...
                        <input placeholder="{{Translation::get('add-discount-code', 'cart', 'Voeg kortingscode toe')}}"
                               class="w-3/5 xl:w-2/3 px-2 focus:outline-none text-primary-500"
                               wire:model.lazy="discountCode">
                        <button type="submit" class="w-2/5 xl:w-1/3 ml-4 lg:ml-2 xl:ml-4 button--white py-2 focus:outline-none"
                ...
                <div class="flex">
                    <a href="{{ShoppingCart::getCheckoutUrl()}}"
                       class="button--white mt-5 py-2 px-2 w-full uppercase text-center">
                        {{Translation::get('proceed-to-checkout', 'cart', 'Doorgaan naar afrekenen')}}
                    </a>
                </div>
            </div>
        </div>
