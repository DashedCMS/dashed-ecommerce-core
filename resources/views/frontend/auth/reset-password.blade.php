    ...
    <x-container>
        <div class="py-0 sm:py-8 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            <form class="flex flex-col space-y-6" method="post" action="{{AccountHelper::getRegisterPostUrl()}}">
                ...
                <button
                    class="button button-white-on-primary w-full">{{Translation::get('register', 'login', 'Registreren')}}</button>
            </form>
            <form method="post" action="{{AccountHelper::getLoginPostUrl()}}"
                ...
                <button
                    class="button button-white-on-primary mt-auto">{{Translation::get('login', 'login', 'Inloggen')}}</button>
            </form>
