                ...
                <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                    ...
                    <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-3xl tracking-tight text-gray-900">{{ CurrencyHelper::formatPrice($product->currentPrice) }}
                            ...
                            @if($product->discountPrice)
                                <span
                                    class="text-sm line-through ml-2">{{CurrencyHelper::formatPrice($product->discountPrice)}}</span>
                            @endif
                        </div>
                        ...
                        @php($characteristics = $product->showableCharacteristics())
                        @if($characteristics)
