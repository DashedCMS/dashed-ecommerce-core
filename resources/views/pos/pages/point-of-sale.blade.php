<div class="relative w-full h-full"
  ...
  <path stroke-linecap="round" stroke-linejoin="round"
        d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12"/>
            ...
            <div
                class="fixed inset-x-0 bottom-0 z-40 max-h-[85vh] portrait:max-h-[85vh] landscape:max-h-[60vh] px-4 pt-4 pb-6 rounded-t-2xl border-t border-primary-500 bg-black/95 md:px-0 md:pt-0 md:pb-0 md:max-h-none md:static md:col-span-3 md:pl-8 md:rounded-none md:border-t-0 md:bg-transparent flex flex-col gap-4 md:gap-8 overflow-y-auto transition-transform duration-300 ease-out"
