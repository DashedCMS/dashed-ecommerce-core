{{-- POS modals, moderne donkere variant. Alleen visuele classes wijken af van pos-modals.blade.php; alle Alpine/wire/Blade logica is identiek. Hoort binnen de POSData() root-div van de moderne layout. --}}
    <div
        ...
        <div class="bg-neutral-900 text-white border border-white/10 rounded-2xl p-8 grid gap-4 relative">
            ...
            <form wire:submit.prevent="submitChangeProductForm">
                <div class="grid gap-4">
                    ...
                    <div>
                        <button type="submit"
                                class="px-4 py-2 text-lg uppercase rounded-xl bg-primary-500 hover:bg-primary-600 transition-all ease-in-out duration-300 text-white font-bold w-full">
                            Aanpassen
                        </button>
                    </div>
                </div>
            ...
            <div class="rounded-2xl p-8 grid gap-4">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <button disabled x-show="!cashPaymentAmount && !isPinTerminalPayment && !postPay"
                            x-bind:class="loading ? 'bg-primary-500/50' : 'bg-primary-500/50'"
                            x-bind:disabled="loading"
                            class="px-4 py-4 text-lg uppercase rounded-xl bg-primary-500/50 transition-all ease-in-out duration-300 text-white font-bold w-full">
                        Vul een bedrag in
                    </button>
                            ...
                            <div class="grid gap-4 bg-white/5 border border-white/10 rounded-xl p-4">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    <button @click="printOrder(selectedOrder)"
                                            class="h-12 w-fit px-2 py-1 gap-2 bg-primary-500 text-white hover:bg-primary-600 transition-all duration-300 ease-in-out rounded-full flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                             stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
