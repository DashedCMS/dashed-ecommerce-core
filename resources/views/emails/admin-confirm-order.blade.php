                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('admin-order-confirmation-email-title', 'orders', 'Je hebt een nieuwe bestelling ontvangen: #:orderId:!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! nl2br(Translation::get('admin-order-confirmation-email-content', 'orders', 'Je kan de bestelling bekijken in het CMS.', 'textarea'))!!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                ...
                                                                                target="_blank"> {{Translation::get('order-confirmation-email-view-order-button', 'orders', 'Bekijk bestelling')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        @if($order->orderProducts()->where('sku', 'payment_costs')->first() && $order->orderProducts()->where('sku', 'payment_costs')->first()->price > 0.00)
                                                            <tr>
                                                                <td width="75%"
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                                <span
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; color: #999999;">{{Translation::get('order-confirmation-email-order-payment-costs', 'orders', 'Betalingskosten')}} </span>
                                                                </td>
                                                                <td width="25%" align="right"
                                                                    style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;">
                                                                <span
