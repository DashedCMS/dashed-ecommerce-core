                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('admin-order-confirmation-email-title', 'orders', 'You have received an order #:orderId:!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! nl2br(Translation::get('admin-order-confirmation-email-content', 'orders', 'U can view this order in the admin.', 'textarea'))!!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                ...
                                                                                target="_blank"> {{Translation::get('order-confirmation-email-view-order-button', 'orders', 'View order')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
