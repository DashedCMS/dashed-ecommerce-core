                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-confirmation-email-title', 'orders', 'Your order #:orderId: has been received!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br> {!! Translation::get('order-confirmation-email-greeting', 'orders', 'Dear :name:,', 'text', [
    'name' => $order->name
]) !!} <br><br>

                                                                    {!! nl2br(Translation::get('order-confirmation-email-content', 'orders', 'U will be notified when there are updates for your order.', 'textarea')) !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                ...
                                                                                target="_blank"> {{Translation::get('order-confirmation-email-view-order-button', 'orders', 'View order online')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
