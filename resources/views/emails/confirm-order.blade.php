                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-confirmation-email-title', 'orders', 'Je bestelling #:orderId: is ontvangen!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br> {!! Translation::get('order-confirmation-email-greeting', 'orders', 'Hallo :name:,', 'text', [
    'name' => $order->name
]) !!} <br><br>

                                                                    {!! nl2br(Translation::get('order-confirmation-email-content', 'orders', 'We laten het je weten als er een update over je bestelling is.', 'textarea')) !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            valign="middle"><a
                                                                                ...
                                                                                target="_blank"> {{Translation::get('order-confirmation-email-view-order-button', 'orders', 'Bekijk bestelling online')}} </a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
