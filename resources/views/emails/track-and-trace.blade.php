                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-track-and-trace-email-title', 'track-and-trace', 'Hey :name:', 'text', [
'name' => $trackAndTrace->order->name
])}}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br>
                                                                    {!! Translation::get('order-track-and-trace-email-content', 'track-and-trace', 'Je bestelling is ingepakt. De volgende track&trace code(s) zijn beschikbaar.', 'editor') !!}
                                                                    <hr>
                                                                    @foreach($trackAndTrace->order->trackAndTraces as $trackAndTrace)
                                                                        <p>
                                                                            <a href="{{$trackAndTrace->url ?: '#'}}">{{$trackAndTrace->delivery_company . ': ' . $trackAndTrace->code}}</a>
                                                                        </p>
                                                                    @endforeach
                                                                </div>
                                                            </td>
