                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    {{Translation::get('order-cancelled-email-title', 'orders', 'Your order #:orderId: has been cancelled!', 'text', [
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br> {!! Translation::get('order-cancelled-email-greeting', 'orders', 'Dear :name:,', 'text', [
    'name' => $order->name
]) !!} <br><br>

                                                                    {!! nl2br(Translation::get('order-cancelled-email-content', 'orders', 'Your order has been cancelled.', 'textarea')) !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
