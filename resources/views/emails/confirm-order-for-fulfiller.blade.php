        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
            ...
            <tr>
                ...
                'siteName' => Customsetting::get('site_name'),
                                                        ...
                                                        <tr>
                                                            <td align="left" class="link-wrap"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <br> {!! Translation::get('order-confirmation-for-fulfiller-email-greeting', 'orders', 'Hallo,') !!}
                                                                    <br><br>

                                                                    {!! nl2br(Translation::get('order-confirmation-for-fulfiller-email-content', 'orders', 'Er is een bestelling met producten die jullie mogen fulfillen.', 'textarea')) !!}
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        {{--                                                        <tr>--}}
                                                        ...
                                                        {{--                                                                                target="_blank"> {{Translation::get('order-confirmation-for-fulfiller-email-view-order-button', 'orders', 'Bekijk bestelling online')}} </a>--}}
                                                        {{--                                                                        </td>--}}
                                                        {{--                                                                    </tr>--}}
                                                        {{--                                                                </table>--}}
                                                        {{--                                                            </td>--}}
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 20px; color: #333; padding-left: 10px;">
                                                    <div
                                                        ...
                                                        {{Translation::get('order-confirmation-for-fulfiller-email-contact-information', 'orders', 'Contact informatie') . ':'}}
                                                    </div>
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                        <strong>{{Translation::get('order-confirmation-for-fulfiller-email-order-number', 'orders', 'Bestelnummer') . ':'}}
                                                        </strong>
                                                        {{$order->invoice_id}}<br></div>
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                        <strong>{{Translation::get('order-confirmation-for-fulfiller-email-ordered-at', 'orders', 'Besteld op') . ':'}}
                                                        </strong> {{$order->created_at->format('d-m-Y H:i')}}<br></div>

                                                    @if($sendProductsToCustomer)
                                                        @if($order->phone_number)
                                                            <div
                                                                style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                                <strong>{{Translation::get('order-confirmation-for-fulfiller-email-phone-number', 'orders', 'Telefoonnummer') . ':'}}
                                                                </strong> {{$order->phone_number}}<br/></div>
                                                        @endif
                                                        <div
                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                            <strong>{{Translation::get('order-confirmation-for-fulfiller-email-email', 'orders', 'Email') . ':'}}
                                                            </strong> {{$order->email}}<br/></div>
                                                    @else
                                                        @if(Customsetting::get('company_phone_number'))
                                                            <div
                                                                style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                                <strong>{{Translation::get('order-confirmation-for-fulfiller-email-phone-number', 'orders', 'Telefoonnummer') . ':'}}
                                                                </strong> {{Customsetting::get('company_phone_number')}}
                                                                <br/></div>
                                                        @endif
                                                        <div
                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                            <strong>{{Translation::get('order-confirmation-for-fulfiller-email-email', 'orders', 'Email') . ':'}}
                                                            </strong> {{Customsetting::get('site_to_email')}}<br/></div>
                                                    @endif
                                                </td>
                                            </tr>
                                        </table>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                        ...
                                                        <tr class="products-list-header"
                                                            ...
                                                            <th class="image-column" width="55%" align="left"
                                                                ...
                                                                {{Translation::get('order-confirmation-for-fulfiller-email-order-details', 'orders', 'Bestellings details')}}
                                                            </th>
                                                            <th class="price-column" width="45%" align="right"
                                                                style="line-height: 18px; padding-bottom: 18px; color: #333;">
                                                                {{Translation::get('order-confirmation-for-fulfiller-email-order-number', 'orders', 'Bestelnummer')}}
                                                                : {{$order->invoice_id}}
                                                            </th>
                                                        </tr>
...
{{--                                                        {{Translation::get('order-confirmation-for-fulfiller-email-shipping-method', 'orders', 'Verzend methode') . ':'}}--}}
{{--                                                    </div>--}}
{{--                                                    <div--}}
{{--                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">--}}
{{--                                                        <div--}}
...
{{--                                                    <div--}}
{{--                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: bold; margin-bottom: 8px;">--}}
{{--                                                        {{Translation::get('order-confirmation-for-fulfiller-email-payment-method', 'orders', 'Betaal methode') . ':'}}--}}
{{--                                                    </div>--}}
{{--                                                    <div--}}
{{--                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">--}}
{{--                                                        <div--}}
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 20px; color: #333; padding-left: 10px;">
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: bold; margin-bottom: 8px;">
                                                        {{Translation::get('order-confirmation-for-fulfiller-email-shipping-address', 'orders', 'Verzend adres') . ':'}}
                                                    </div>
                                                    @if($sendProductsToCustomer)
                                                        <div
                                                            style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            {{ Customsetting::get('company_street') }} {{ Customsetting::get('company_street_number') }}
                                                            <br>
                                                            {{ Customsetting::get('company_postal_code') }} {{ Customsetting::get('company_city') }}
                                                            <br>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 20px; color: #333; padding-left: 10px;">
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: bold; margin-bottom: 8px;">
                                                        {{Translation::get('order-confirmation-for-fulfiller-email-invoice-address', 'orders', 'Factuur adres') . ':'}}
                                                    </div>
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                        @if($order->company_name)
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; line-height: 20px; color: #333; padding-left: 10px;">
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 16px; font-weight: bold; margin-bottom: 8px;">
                                                        {{Translation::get('order-confirmation-for-fulfiller-email-note', 'orders', 'Notitie') . ':'}}
                                                    </div>
                                                    <div
                                                        style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 14px;">
                                                        {{$order->note}}
