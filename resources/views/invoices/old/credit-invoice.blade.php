...
<head>
    ...
    <title>{{Translation::get('credit-invoice', 'credit-invoice', 'Credit invoice')}} {{Customsetting::get('site_name')}}</title>
    <style>
        .credit-invoice-box {
            max-width: 800px;
            margin: auto;
...
<div class="credit-invoice-box">
    ...
    <div>
        <table class="border-product">
            ...
            {{--                        {{CurrencyHelper::formatPriceForPDF($order->shipping_costs, 'EUR', true)}} @else {{Translation::get('free-shipping', 'credit-invoice', 'Free')}} @endif--}}
            {{--                </td>--}}
            {{--            </tr>--}}
